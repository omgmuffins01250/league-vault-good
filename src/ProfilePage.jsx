              ...
              <div className="avatar placeholder">
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-primary/10 text-primary">
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M12 2a5 5 0 0 0-5 5v1a5 5 0 0 0 10 0V7a5 5 0 0 0-5-5Zm0 12c-5.333 0-9 3.84-9 8a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1c0-4.16-3.667-8-9-8Z" />
                  </svg>
                </div>
              </div>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-3">
          <div className="card bg-white shadow lg:col-span-2">
            <div className="card-body space-y-4">
              ...
              <div className="rounded-box bg-gray-200 p-4">
          ...
          <div className="card bg-white shadow">
            <div className="card-body space-y-4">
              ...
              <dl className="space-y-4 text-sm">
                <div>
                  <dt className="font-semibold text-gray-600 uppercase">
                    Time zone
                  </dt>
              ...
              <div className="rounded-box bg-gray-200 p-4 text-sm text-gray-600">
